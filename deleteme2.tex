...
%\section{Tactile SWIM for Haptic Augmented Reality Computer-Aided Design}
\section{T-SWIM for Haptic Augmented Reality CAD/CAM}
...
\begin{figure}
  ...
  \caption{Mann's early haptic radio wave experiment using X-Y plotter
           ...
           Here a single light bulb traces out the waveform of the plotter's
           pen which is held by a user, to feel the radio wave return of an
           antenna mounted to the moving bar of the plotter.
           The X-axis servo is disabled so the user can slide it freely
           back-and-forth while the Y-axis is driven by the output of
           a lock-in amplifier connected to a stationary reference
           antenna and a moving signal antenna.
  \label{fig:plotter}
\end{figure}
This suggests the use of haptics to collaboratively create phsical objects
(Fig.~\ref{fig:tswims}.
